...
const API = "https://functions.poehali.dev/2839c236-326f-4a8d-b64c-b9c5c8d9cc62";
...
export default function EcsuFinance() {
          ...
          {!loading && tab === "overview" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-white/30 text-sm mt-1">Все счета · Николаев В.В.</p>
              </div>
            ...
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              {modal === "account" && (
                <>
                  ...
                  {[
                    { key: "owner_name", label: "Владелец / Название *", ph: "Николаев В.В." },
                ...
                <>
                  ...
                  <div>
                    ...
                    <input value={cardForm.card_holder} onChange={e => setCardForm(f => ({ ...f, card_holder: e.target.value }))}
                      placeholder="VLADIMIR NIKOLAEV" className="w-full px-3 py-2.5 rounded-xl text-white text-sm outline-none uppercase"
                      style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }} />
                  </div>
                  <div>
