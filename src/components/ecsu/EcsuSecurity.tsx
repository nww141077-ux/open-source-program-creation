...
const threats = [
  { id: "THR-001", type: "DDoS", source: "Внешняя сеть", target: "ecsu-nww.com · 5.129.207.35", level: "critical", time: "14:31", details: "Массированная DDoS-атака на сервер ЕЦСУ (5.129.207.35). Пиковая нагрузка: 48 Гбит/с. Источник — ботнет из 3 200 узлов.", action: "Трафик перенаправлен через защищённый прокси. Атакующие адреса внесены в блок-лист. Атака нейтрализована в 14:47." },
  { id: "THR-002", type: "Brute Force", source: "Внешний IP", target: "API авторизации ЕЦСУ", level: "high", time: "13:44", details: "Зафиксировано 14 700 попыток подбора пароля к API авторизации за 12 минут.", action: "IP заблокирован. Введена защита на уровне шлюза." },
  { id: "THR-003", type: "SQL Injection", source: "Внешний IP", target: "БД ЕЦСУ PostgreSQL", level: "critical", time: "12:20", details: "Попытка SQL-инъекции через уязвимый параметр в API поиска. Атака остановлена WAF.", action: "Уязвимость изолирована, патч применён в 12:35. Целостность данных проверена." },
  { id: "THR-004", type: "Сканирование портов", source: "Внешняя сеть", target: "Сервер 5.129.207.35", level: "medium", time: "11:05", details: "Автоматизированное сканирование портов сервера ЕЦСУ. Закрытые порты: 3389, 389, 587, 465, 25.", action: "Источник внесён в блок-лист. Закрытые порты подтверждены." },
  { id: "THR-005", type: "Фишинг", source: "Email", target: "nikolaevvladimir77@yandex.ru", level: "low", time: "09:30", details: "Попытка фишинга на почту владельца системы. Имитация официальной переписки.", action: "Письма помещены в карантин. Отправитель заблокирован." },
];
