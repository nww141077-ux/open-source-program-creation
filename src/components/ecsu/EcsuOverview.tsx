    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-[#0d1225] border border-blue-900/30 rounded-xl p-4">
          ...
          <div className="mt-3 pt-3 border-t border-blue-900/30 space-y-1 text-xs">
            {[
              { label: "Срочность", val: "Активная", color: "#e94560" },
              { label: "Приоритет", val: "Расследование", color: "#f59e0b" },
              { label: "Статус", val: "Рейтинг", color: "#3b82f6" },
              { label: "Статус", val: "Дежурство", color: "#f59e0b" },
            ].map((r, i) => (
